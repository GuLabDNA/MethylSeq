...
###################################
#luad
lung1 <- ca_long_ex2 %>% filter(CellType=="Lung-Ep-Alveo")  
...
###################################
#brca
brca1 <- ca_long_ex2 %>% filter(CellType=="Breast-Luminal-Ep")
...
###################################
#DLBC
lympho1 <- ca_long_ex2 %>% filter(CellType=="Blood-B") 
...
###################################
#COAD
coad1 <- ca_long_ex2 %>% filter(CellType=="Colon-Ep") 
...
###################################
#STAD
stad1 <- ca_long_ex2 %>% filter(CellType=="Gastric-Ep") 
...
###################################
#OV
ov1 <- ca_long_ex2 %>% filter(CellType=="Ovary-Ep") 
...
###################################
oligo1 <- ca_long_ex2 %>% filter(CellType=="Oligodend") 
...
###################################
neuron1 <- ca_long_ex2 %>% filter(CellType=="Neuron") 
